                ...
                {payments.map((payment) => (
                  <TableRow key={payment.id}>
                    ...
                    <TableCell className="text-center">
                      {payment.status === "paid" ? (
                        <Badge className="bg-emerald-100 text-emerald-700"><CheckCircle className="h-3 w-3 mr-1" />Pagado</Badge>
                      ) : (
                        <Badge className="bg-amber-100 text-amber-700"><Clock className="h-3 w-3 mr-1" />Pendiente</Badge>
                      )}
                    </TableCell>
