    ...
    win.document.write(`
      ...
      <head>
        ...
        <style>
          ...
          .total-box { padding: 10px; border: 2px solid #000; margin: 10px 0; }
          .green { color: #16a34a; }
          .red { color: #dc2626; }
        </style>
      </head>
      <body>
        ...
        <div class="total-box">
          <div class="row" style="font-weight: bold; font-size: 14px;">
            ...
            <span class="${disc.total === 0 ? 'green' : 'red'}">€${fmt(disc.total)}</span>
          </div>
        </div>
        
        <div style="text-align: center; font-size: 10px; margin-top: 15px;">
          --- Documento de arqueo ---<br/>
          Conservar con la recaudación
        </div>
      </body>
      </html>
    `);
