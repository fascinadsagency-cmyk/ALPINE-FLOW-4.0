  ...
  return (
    <div className={`p-6 lg:p-8 space-y-8 min-h-screen transition-colors duration-300 ${darkMode ? 'bg-[#121212]' : 'bg-slate-50'}`} data-testid="dashboard">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 relative z-10">
        ...
        <Card 
          className="relative overflow-hidden cursor-pointer group hover:shadow-xl transition-all duration-300 bg-white border border-slate-200"
        ...
        >
          ...
          <CardContent className="p-3 relative">
            <div className="flex items-start justify-between mb-2">
              ...
              <ChevronRight className="h-3.5 w-3.5 text-slate-300 group-hover:text-blue-500 group-hover:translate-x-1 transition-all" />
            </div>
            <div>
              ...
              <p className="text-[10px] text-slate-400">En curso ahora mismo</p>
            </div>
          </CardContent>
        </Card>
        ...
        >
          ...
          <CardContent className="p-3 relative">
            <div className="flex items-start justify-between mb-2">
              ...
              <ChevronRight className="h-3.5 w-3.5 text-slate-300 group-hover:text-purple-500 group-hover:translate-x-1 transition-all" />
            </div>
        ...
        >
          ...
          <CardContent className="p-3 relative">
            <div className="flex items-start justify-between mb-2">
              ...
              <ChevronRight className="h-3.5 w-3.5 text-slate-300 group-hover:text-cyan-500 group-hover:translate-x-1 transition-all" />
            </div>
            <div>
              ...
              <p className="text-[10px] text-slate-400">Material alquilado</p>
            </div>
          </CardContent>
        </Card>
        ...
        >
          ...
          <CardContent className="p-3 relative">
            <div className="flex items-start justify-between mb-2">
              ...
              <ChevronRight className="h-3.5 w-3.5 text-slate-300 group-hover:text-indigo-500 group-hover:translate-x-1 transition-all" />
            </div>
            <div>
              ...
              <p className="text-[10px] text-slate-400">Clientes únicos atendidos</p>
            </div>
          </CardContent>
        </Card>
      </div>
